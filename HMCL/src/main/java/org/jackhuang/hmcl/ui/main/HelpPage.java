...
public class HelpPage extends SpinnerPane {
    ...
    private void loadHelp() {
        ...
        Task.<List<HelpCategory>>supplyAsync(() -> HttpRequest.GET("https://paradise.mahoutsukai.cn/api/tilty/config/json?key=paradise-hmcl-help").getJson(listTypeOf(HelpCategory.class)))
