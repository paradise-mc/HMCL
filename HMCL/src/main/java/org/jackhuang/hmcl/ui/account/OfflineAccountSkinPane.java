...
public class OfflineAccountSkinPane extends StackPane {
    ...
    public OfflineAccountSkinPane(OfflineAccount account) {
        ...
        FXUtils.onChangeAndOperate(skinItem.selectedDataProperty(), selectedData -> {
            ...
            switch (selectedData) {
                ...
                case PARADISE:
                    ...
                    hint.setText(i18n("account.skin.type.paradise.hint"));
        ...
        JFXHyperlink paradiseLink = new JFXHyperlink(i18n("account.skin.type.paradise"));
        paradiseLink.setOnAction(e -> FXUtils.openLink("https://paradise.mahoutsukai.cn/"));
        JFXButton cancelButton = new JFXButton(i18n("button.cancel"));
        cancelButton.getStyleClass().add("dialog-cancel");
        cancelButton.setOnAction(e -> fireEvent(new DialogCloseEvent()));
        onEscPressed(this, cancelButton::fire);

        layout.setActions(paradiseLink, acceptButton, cancelButton);
    }
