...
public final class Controllers {
    public static final int MIN_WIDTH = 1024 + 2 + 16; // bg width + border width*2 + shadow width*2
    public static final int MIN_HEIGHT = 576 + 2 + 40 + 16; // bg height + border width*2 + toolbar height + shadow width*2
